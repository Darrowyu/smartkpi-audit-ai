...
const SettingsView: React.FC<SettingsViewProps> = ({ language, setLanguage, t, onLogout }) => {
        ...
        {onLogout && (
          <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-semibold text-slate-800">{language === 'zh' ? '账户' : 'Account'}</h3>
            </div>
