...
const getProgressColor = (progress: number): string => {
  ...
  if (progress >= 70) return 'bg-brand-primary';
...
const getProgressTextColor = (progress: number): string => {
  ...
  if (progress >= 70) return 'text-brand-primary';
...
const getAvatarBg = (name: string): string => {
  const colors = ['bg-brand-primary', 'bg-emerald-500', 'bg-amber-500', 'bg-purple-500', 'bg-pink-500'];
